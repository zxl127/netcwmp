...
#define LIGHT_RED     "\033[1;35m"   
#define GREEN         "\033[0;32m"   
#define LIGHT_GREEN   "\033[1;32m"   
#define YELLOW        "\033[1;33m"   
#define WHITE         "\033[1;37m"   

#define FUNCTION_TRACE()				printf("[Trace] %s\r\n",  __func__)
#define cwmp_log_debug(fmt, args...) 	printf(GREEN"[Debug] "NONE#fmt"\r\n", ##args)
#define cwmp_log_info(fmt, args...) 	printf(LIGHT_GREEN"[Infor] "NONE#fmt"\r\n", ##args)
#define cwmp_log_error(fmt, args...) 	printf(LIGHT_RED"[Error] "NONE#fmt"\r\n", ##args)
#define cwmp_log_alert(fmt, args...) 	printf(YELLOW"[Alert] "NONE#fmt"\r\n", ##args)
#define cwmp_log_critical(fmt, args...) printf(RED"[Criti] "NONE#fmt"\r\n", ##args)
